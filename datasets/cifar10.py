...
class Cifar10Data(Dataset):
    ...
    def build_dataset(self):
        ...
        self.data = torchvision.datasets.CIFAR10(root=self.data_conf['data_path'], train=True,
                                        download=True, transform=self.transform)
        self.test_data  = torchvision.datasets.CIFAR10(root=self.data_conf['data_path'], train=False,
                                       download=True, transform=self.transform)
